...
export default function Features({}: Props) {
  ...
  return (
    <section className="relative flex flex-col gap-16 mt-40 md:items-center md:flex-row">
      <div className="w-full md:w-[40%] xl:ml-[12.5rem]">
        ...
        <div className="flex flex-row mt-16 md:flex-col">
          <article
            className={
              displayedFeature === "workspace"
                ? "px-6 py-8 border-t-2 md:border-t-0 md:border-l-2 hover:bg-zinc-100 border-black cursor-pointer"
                : "px-6 py-8 border-t md:border-t-0 md:border-l hover:bg-zinc-100 border-zinc-200 cursor-pointer"
            }
